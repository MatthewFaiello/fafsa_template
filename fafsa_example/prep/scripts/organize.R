...
table(fafsa0$SchoolYear, fafsa0$Gender, useNA = "always")
table(fafsa0$SchoolYear, fafsa0$RaceReportTitle, useNA = "always")

# Keep only schools that still exist, then restore display names
fafsa1 <- 
  fafsa0 %>%
